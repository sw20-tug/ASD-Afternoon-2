...
object DBName {
    ...
    const val CREATE_ACTIVITY_AVAILABILITY_TABLE: String =
        "CREATE TABLE " + ACTIVITY_AVAILABILITY_TABLE_NAME +
                "( " + HOTEL_ACTIVITY_AVAILABILITY_ID_COLUMN + " INTEGER FOREIGN KEY, " +
                HOTEL_ACTIVITY_AVAILABILITY_HOTEL_ID_COLUMN + " INTEGER FOREIGN KEY," +
                "FOREIGN KEY (" + HOTEL_ACTIVITY_AVAILABILITY_ID_COLUMN + ") REFERENCES " + ACTIVITY_TABLE_NAME + "" +
                "(" + HOTEL_ACTIVITY_ID_COLUMN + ")," +
                "FOREIGN KEY (" + HOTEL_ACTIVITY_AVAILABILITY_HOTEL_ID_COLUMN + ") REFERENCES " + HOTEL_TABLE_NAME + "" +
                "(" + HOTEL_ID_COLUMN + "));"
